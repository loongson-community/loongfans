...
export const osDataList = [
  ...
  {
    name: "Buildroot",
    description: "用于通过交叉编译构建嵌入式 Linux 系统的工具",
  ...
  },
  {
    ...
    tags: ["可获取商业支持", "服务器", "嵌入式", "Linux", "ABI2.0", "ABI1.0"],
  },
  {
    name: "OpenWrt",
