export default {
  basic: {
    ...
    market:
      "市场定位指龙芯中科认定的，该产品所适合的定位和使用场景，不代表基于该芯片的产品的最终实际用途。",
  },
  cpu: {
  ...
  package: {
    ...
    t_case:
      " (Case Temperature) 是指芯片外壳表面被允许达到的最高温度。\n\n请注意：",
    t_junction:
      "(Junction Temperature) 是指芯片内部、晶体管单元的最高工作温度。\n\n请注意：",
    t_notice: "温度可作为对散热器性能及工作环境提出的要求。",
  },
  power: {
    clock_gating:
      "时钟动态关闭 (Clock Gating) 是一种节电技术，在电路模块空闲时，暂时关闭其时钟信号，从而避免不必要的动态功耗消耗。",
    frequency_scaling:
      "时钟动态变频是处理器根据实时负载与功耗需求，动态调整其工作频率。",
    voltage_scaling:
      "动态调压是指处理器根据当前工作频率和负载，在指定的电压范围内动态调整其核心工作电压",
  },
  tech: {
    isa: {
