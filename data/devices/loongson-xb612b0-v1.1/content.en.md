...
Compared to the [AC612A0_V1.1](/en/devices/loongson-ac612a0-v1.1.md) based on Loongson 3C6000/S, the XB612B0_V1.1 motherboard provides two fewer memory slots and one fewer PCIe 3.0 x8 interface. However, considering its relatively smaller form factor, this motherboard still has a remarkable feature set and expandability, and offers better value for money for personal buyers.
:::
...
| Processor | 3B6000 (8/12/16 cores) @ 2.3/2.2/2.1GHz |
