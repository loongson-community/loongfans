...
:::info
La Loongson XB612B0_V1.1 est une carte mère de bureau au format mATX (244 × 244 mm) basée sur le processeur Loongson 3B6000.
...
Par rapport au [AC612A0_V1.1](/en/devices/loongson-ac612a0-v1.1.md) Basée sur le processeur Loongson 3C6000/S, la carte mère XB612B0_V1.1 dispose de deux emplacements mémoire et d'une interface PCIe 3.0 x8 en moins. Toutefois, compte tenu de son format relativement compact, cette carte mère offre tout de même un ensemble de fonctionnalités et une évolutivité remarquables, et présente un meilleur rapport qualité-prix pour les particuliers.
:::
...
| Processeur | 3B6000 (8/12/16 cores) à 2,3/2,2/2,1 GHz |
| Mémoire | DDR4 à 3200 MT/s (2 × barrettes DIMM), compatible RECC |
...
| Interfaces (réseau) | 2 ports Gigabit Ethernet |
| Interfaces (vidéo) | 1 × HDMI, 1 × VGA |
| Interfaces (Autres) | 1 interface M.2 Key E (PCIe + USB), 1 ensemble d'interfaces 3,5 mm (entrée, sortie, entrée ligne), 1 port série RS-232 (DB-9) |
