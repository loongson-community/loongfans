...
Cette carte mère est un modèle d'entrée de gamme Loongson 3C6000/S, doté d'un ensemble d'interfaces relativement complet et prenant en charge les modules de gestion hors bande (BMC) pour l'exploitation et la gestion à distance.
:::
...
| Mémoire | DDR4 à 3200 MT/s (4 modules DIMM), compatible avec la technologie RECC |
...
| Interfaces (vidéo) | Une sortie VGA |
| Interfaces (Autres) | 1 × interface de module BMC†‡, 1 × interface réseau BMC, 1 × interface M.2 Key E (PCIe + USB), 1 × mPCIe (PCIe + USB), 1 jeu d'interfaces 3,5 mm (entrée, sortie), 1 × port série RS-232 (DB-9) |
