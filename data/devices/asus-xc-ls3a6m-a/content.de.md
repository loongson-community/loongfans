...
| Anschlüsse (USB) | USB 3.0 (2 × auf der Hauptplatine, 3 × an der Vorderseite), USB 2.0 (4 × auf der Hauptplatine, 1 × an der Vorderseite) |
| Schnittstellen (Speicher) | 1 × NVMe (PCIe 3.0 x4), 4 × SATA 3.0 |
| Schnittstellen (Netzwerk) | 1 × GbE |
| Anschlüsse (Video) | 1 × HDMI, 1 × VGA |
| Anschlüsse (Sonstiges) | 1 × M.2-Key-E-Anschluss (PCIe + USB), 1 × mPCIe (PCIe + USB), 1 Satz 3,5-mm-Anschlüsse (Eingang, Ausgang, Line-In) |
