...
Cette carte mère est un modèle d'entrée de gamme Loongson 3C6000/S, dotée d'un ensemble d'interfaces relativement complet et prenant en charge les modules de gestion hors bande (BMC) pour l'exploitation et la gestion à distance.
:::
