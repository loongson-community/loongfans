...
翻译本项目相关内容，或进行本项目相关的 OCR、语音转文字、文字转语音等多模态任务时，可能遇到许多领域相关用语与黑话。以下是相关术语及对应的解释。
...
- 龙架构、龙芯架构: LoongArch
- 我国: China
- 中国大陆: 如内容在中国大陆法域分发，则按照中国大陆有关规定，需译为 Chinese mainland，禁用 mainland China。
- 自主/自主研发: independently developed / indigenous
- 新世界 (ABI2.0): New World (ABI2.0)
  - ABI2.0 系统: ABI2.0 systems
- 旧世界 (ABI1.0): Old World(ABI1.0)
