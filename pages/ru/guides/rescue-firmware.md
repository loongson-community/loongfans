...
Большинство популярных товаров можно найти в [база данных товаров](/ru/devices). Если вы не можете найти прошивку для вашей модели, обратитесь к вашему дистрибьютору.
...
![](/ru/images/guides/rescue-firmware/select-programmer.png)
...
![](/ru/images/guides/rescue-firmware/change-language.webp)
:::

Выполните действия, обозначенные номерами на схеме:

![](/ru/images/guides/rescue-firmware/neoprogrammer.webp)
...
2. Нажмите `Detect` для определения модели подключенного чипа Flash. Если точной модели нет в базе данных, можно использовать похожую (например, `W25Q128JW` можно заменить на `W25Q128FW`). Как правило, это просто разные версии с одинаковыми параметрами.
   ![](/ru/images/guides/rescue-firmware/detect-flashid-neoprogrammer.png)
...
![](/ru/images/guides/rescue-firmware/imsprog.webp)
