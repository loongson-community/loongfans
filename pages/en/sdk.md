...
| 2K3000/3B6000M SoC CAN-FD Bus | Feature | `CAN_LSCANFD` (bool: y/n), `CAN_LSCANFD_PLATFORM` (tristate: y/m/n) | [1](https://github.com/AOSC-Tracking/linux/commit/905bf46bcebfb) | Must be used together with Linux 7.1 or newer kernel with multi-channel DMA support |
...
| Workaround for inoperable GPIO due to device descriptions that only complies with an old release of *Loongson CPU Unified System Architecture Specification*, where GPIO devices were described within `gsi_idx_map` | Workaround | N/A | [1](https://lore.kernel.org/all/20260630-loongson-gpio-v1-1-576908831fa0@gmail.com/) | Should not affect 2K3000/3B6000M and later products |
